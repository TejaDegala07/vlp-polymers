...
This is the full-stack web application for VLP Polymers (Venkateswara Lovaprasad Exports).

## Project Structure

The project is structured into two main directories:

- **frontend/**: A Next.js 14 web application built with React, Tailwind CSS, and shadcn/ui.
- **backend/**: A Strapi 5 headless CMS utilizing PostgreSQL for database management.
